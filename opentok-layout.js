...
(function($) {
    ...
    var arrange = function arrange(children, Width, Height, offsetLeft, offsetTop, fixedRatio, minRatio, maxRatio, animate, alignTop) {
        ...
        if ( (alignTop) && ((vidRatio.targetHeight * vidRatio.targetRows) < (Height)) ) {
        	firstRowMarginTop = 0;
        }
    ...
    var layout = function layout(container, opts, fixedRatio) {
        ...
        if (bigOnes.length > 0 && smallOnes.length > 0) {
        	...
        	if ( (opts.presentationMode == presentationMode.HANGOUT) || ( (opts.presentationMode != presentationMode.PIP) && (availableRatio > bigRatio) ) ) {
            ...
            if (opts.bigFirst) {            	            	
            	if (opts.smallBottom) {
            		arrange(smallOnes, Width - offsetLeft, Height - offsetTop, offsetLeft, offsetTop, opts.fixedRatio, opts.minRatio, opts.maxRatio, opts.animate, opts.alignTop);
            		arrange(bigOnes, bigWidth, bigHeight, 0, 0, opts.bigFixedRatio, opts.bigMinRatio, opts.bigMaxRatio, opts.animate, opts.alignTop);
            	} else {
            		arrange(smallOnes, Width - offsetLeft, Height - offsetTop, offsetLeft, 0, opts.fixedRatio, opts.minRatio, opts.maxRatio, opts.animate, opts.alignTop);
            		arrange(bigOnes, bigWidth, bigHeight, 0, bigOffsetTop, opts.bigFixedRatio, opts.bigMinRatio, opts.bigMaxRatio, opts.animate, opts.alignTop);
            	}
            } else {
            	if (opts.smallBottom) {
            		arrange(bigOnes, bigWidth, bigHeight, bigOffsetLeft, 0, opts.bigFixedRatio, opts.bigMinRatio, opts.bigMaxRatio, opts.animate, opts.alignTop);
            		arrange(smallOnes, Width - offsetLeft, Height - offsetTop, 0, offsetTop, opts.fixedRatio, opts.minRatio, opts.maxRatio, opts.animate, opts.alignTop);  
            	} else {
            		arrange(bigOnes, bigWidth, bigHeight, bigOffsetLeft, bigOffsetTop, opts.bigFixedRatio, opts.bigMinRatio, opts.bigMaxRatio, opts.animate, opts.alignTop);
            		arrange(smallOnes, Width - offsetLeft, Height - offsetTop, 0, 0, opts.fixedRatio, opts.minRatio, opts.maxRatio, opts.animate, opts.alignTop);
            	}
            }
        } else if (bigOnes.length > 0 && smallOnes.length === 0) {
            // We only have one bigOne just center it
            arrange(bigOnes, Width, Height, 0, 0, opts.bigFixedRatio, opts.bigMinRatio, opts.bigMaxRatio, opts.animate, opts.alignTop);
        } else {
        	arrange(smallOnes, Width - offsetLeft, Height - offsetTop, offsetLeft, offsetTop, opts.fixedRatio, opts.minRatio, opts.maxRatio, opts.animate, opts.alignTop);
        }
    };
